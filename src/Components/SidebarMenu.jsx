...
export default function SidebarMenu() {
    ...
    const menus = [
        ...
        { to: "/FAQ", icon: <MdRateReview color={iconColor} />, label: "FAQ" },
        { to: "/Galeri", icon: <MdRateReview color={iconColor} />, label: "Galeri" },
        { to: "/UserRole", icon: <MdRateReview color={iconColor} />, label: "User Role" },
        { to: "/Kontak", icon: <MdRateReview color={iconColor} />, label: "Kontak" },
